export const allExamples = [
  ...
  {
    shape: 'VEHICLE_FUEL',
    examples: ['Gasoline', 'Hybrid', 'Electric', 'Diesel'],
  },
  {
    shape: 'VEHICLE_COLOR',
    examples: [
  ...
  {
    shape: 'SYSTEM_NETWORK_INTERFACE',
    examples: [
      'enp3s3f3d2',
      'ens6',
      'wls0f1',
  ...
  {
    shape: 'SYSTEM_FILE_TYPE',
    examples: ['application', 'text', 'image', 'video', 'audio', 'font'],
  },
  {
    shape: 'PERSON_ZODIAC_SIGN',
    examples: [
      'Cancer',
      'Aries',
      'Gemini',
  ...
  { shape: 'PERSON_PREFIX', examples: ['Mrs.', 'Miss', 'Mr.', 'Dr.', 'Ms.'] },
  {
    shape: 'PERSON_MIDDLE_NAME',
    examples: [
      'Bowie',
      'Addison',
      'Elliott',
  ...
  {
    shape: 'SCIENCE_CHEMICAL_ELEMENT_SYMBOL',
    examples: [
      'Cd',
      'V',
      'Am',
  ...
  {
    shape: 'SCIENCE_CHEMICAL_ELEMENT_NAME',
    examples: [
      'Rhenium',
      'Plutonium',
      'Neptunium',
  ...
  {
    shape: 'SCIENCE_CHEMICAL_ELEMENT_ATOMIC_NUMBER',
    examples: [
      '31',
      '24',
      '101',
  ...
  { shape: 'INDEX', examples: [] },
  {
    shape: 'PERSON_JOB_TITLE',
    examples: [
  ...
  { shape: 'INTERNET_PROTOCOL', examples: ['http', 'https'] },
  {
    shape: 'INTERNET_PORT',
    examples: [
      '64628',
  ...
  { shape: 'TOKEN', examples: [] },
  { shape: 'AGE', examples: [] },
  { shape: 'DATE', examples: [] },
  { shape: 'ZIP_CODE', examples: [] },
  { shape: 'PASSWORD', examples: [] },
  { shape: 'PHONE_NUMBER', examples: [] },
  { shape: 'USER_AGENT', examples: [] },
  { shape: 'CITY', examples: [] },
  {
    shape: 'INTERNET_IPV4',
    examples: [
  ...
  {
    shape: 'INTERNET_HTTP_STATUS_CODE',
    examples: [
      '410',
      '102',
      '206',
  ...
  {
    shape: 'INTERNET_HTTP_METHOD',
    examples: ['POST', 'PATCH', 'PUT', 'DELETE', 'GET'],
  },
  {
    shape: 'INTERNET_EMOJI',
    examples: [
      '👃🏻',
      '🇫🇲',
      '🪖',
  ...
  {
    shape: 'INTERNET_DOMAIN_SUFFIX',
    examples: ['com', 'name', 'org', 'net', 'info', 'biz'],
  },
  {
  ...
  {
    shape: 'IMAGE_TRANSPORT',
    examples: ['https://loremflickr.com/640/480/transport'],
  },
  {
    shape: 'IMAGE_TECHNICS',
    examples: ['https://loremflickr.com/640/480/technics'],
  },
  {
    shape: 'IMAGE_SPORTS',
    examples: ['https://loremflickr.com/640/480/sports'],
  },
  {
    shape: 'IMAGE_PEOPLE',
    examples: ['https://loremflickr.com/640/480/people'],
  },
  {
    shape: 'IMAGE_NIGHTLIFE',
    examples: ['https://loremflickr.com/640/480/nightlife'],
  },
  {
    shape: 'IMAGE_NATURE',
    examples: ['https://loremflickr.com/640/480/nature'],
  },
  { shape: 'IMAGE_URL', examples: ['https://loremflickr.com/640/480'] },
  { shape: 'COUNTRY', examples: [] },
  { shape: 'COUNTRY_CODE', examples: [] },
  { shape: 'FULL_ADDRESS', examples: [] },
  { shape: 'STREET_ADDRESS', examples: [] },
  ...
  { shape: 'IMAGE_FOOD', examples: ['https://loremflickr.com/640/480/food'] },
  {
    shape: 'IMAGE_FASHION',
    examples: ['https://loremflickr.com/640/480/fashion'],
  },
  {
    shape: 'IMAGE_DATA_URI',
    examples: [
  ...
  { shape: 'IMAGE_CITY', examples: ['https://loremflickr.com/640/480/city'] },
  { shape: 'IMAGE_CATS', examples: ['https://loremflickr.com/640/480/cats'] },
  {
    shape: 'IMAGE_BUSINESS',
    examples: ['https://loremflickr.com/640/480/business'],
  },
  {
    shape: 'IMAGE_AVATAR_LEGACY',
    examples: [
  ...
  {
    shape: 'IMAGE_ANIMALS',
    examples: ['https://loremflickr.com/640/480/animals'],
  },
  {
    shape: 'IMAGE_ABSTRACT',
    examples: ['https://loremflickr.com/640/480/abstract'],
  },
  {
    shape: 'HACKER_VERB',
    examples: [
  ...
  { shape: 'TIMEZONE', examples: [] },
  { shape: 'IP_ADDRESS', examples: [] },
  { shape: 'MAC_ADDRESS', examples: [] },
  { shape: 'SYSTEM_SEMVER', examples: [] },
  { shape: 'POST_TITLE', examples: [] },
  { shape: 'POST_COMMENT', examples: [] },
  {
    shape: 'GIT_SHORT_SHA',
    examples: [
      'fc43adb',
  ...
  {
    shape: 'FINANCE_TRANSACTION_TYPE',
    examples: ['invoice', 'payment', 'withdrawal', 'deposit'],
  },
  {
    shape: 'FINANCE_TRANSACTION_DESCRIPTION',
    examples: [
  ...
  {
    shape: 'FINANCE_CREDIT_CARD_ISSUER',
    examples: [
      'maestro',
      'visa',
      'diners_club',
  ...
  { shape: 'POST_BODY', examples: [] },
  { shape: 'RATING', examples: [] },
  { shape: 'ENVIRONMENT_VARIABLE', examples: [] },
  {
    shape: 'FINANCE_CRYPTO_ADDRESS',
    examples: [
  ...
  {
    shape: 'DATABASE_PROVIDER',
    examples: ['mongodb', 'mysql', 'postgres', 'redis', 'rethinkdb'],
  },
  {
    shape: 'DATABASE_MONGODB_OBJECT_ID',
    examples: [
  ...
  {
    shape: 'DATABASE_ENGINE',
    examples: ['InnoDB', 'ARCHIVE', 'CSV', 'BLACKHOLE', 'MEMORY', 'MyISAM'],
  },
  {
  ...
  { shape: 'COMPANY_SUFFIXES', examples: ['Inc', 'and Sons', 'LLC', 'Group'] },
  {
    shape: 'COMPANY_NAME',
    examples: [
      'Grady LLC',
  ...
  {
    shape: 'COMPANY_CATCH_PHRASE_NOUN',
    examples: [
  ...
  {
    shape: 'COMPANY_CATCH_PHRASE_DESCRIPTOR',
    examples: [
      'discrete',
      'even-keeled',
      'well-modulated',
  ...
  {
    shape: 'COMPANY_CATCH_PHRASE_ADJECTIVE',
    examples: [
      'User-centric',
      'Reactive',
      'Programmable',
  ...
  {
    shape: 'COMMERCE_PRODUCT_MATERIAL',
    examples: [
      'Wooden',
      'Steel',
      'Bronze',
  ...
  {
    shape: 'COLOR_CSS_SUPPORTED_SPACE',
    examples: ['display-p3', 'a98-rgb', 'prophoto-rgb', 'sRGB', 'rec2020'],
  },
  {
    shape: 'COLOR_CSS_SUPPORTED_FUNCTION',
    examples: [
      'lch',
      'hsla',
      'cmyk',
  ...
  {
    shape: 'COLOR_COLOR_BY_C_S_S_COLOR_SPACE',
    examples: [
      '0.6154,0.0728,0.398',
  ...
  },
  {
    ...
    examples: [
      ...
      'Salta tuco-tuco',
      "Budi's chinchilla rat,A. budini",
      'Fukomys anselli',
      'Common degu',
      'Brazilian porcupine',
      "Steinbac's tuco-tuco",
      'Lagidium',
      'Furtive tuco-tuco',
  ...
  },
  {
    ...
    examples: [
      ...
      'tech tutorials',
      'industry trends',
      'affordable organic grocery delivery in Chicago',
  ...
  {
    shape: 'AIRLINE_AIRPORT_IATA_CODE',
    examples: [
      'CTU',
      'SEA',
      'DXB',
  ...
  {
    shape: 'AIRLINE_AIRPLANE_IATA_TYPE_CODE',
    examples: [
      '333',
      '320',
      '717',
  ...
  {
    shape: 'AIRLINE_AIRLINE_IATA_CODE',
    examples: [
      'JA',
      'NH',
      '3U',
  ...
  {
    shape: 'AIRLINE_AIRCRAFT_TYPE',
    examples: ['regional', 'narrowbody', 'widebody'],
  },
  {
    shape: 'LOCATION_NEARBY_G_P_S_COORDINATE',
    examples: [
      '-35.862,169.3761',
      '29.9327,-176.5523',
      '46.7842,-86.8615',
  ...
  {
    shape: 'PERMISSION',
    examples: ['no permission', 'write', 'read', 'execute'],
  },
  {
    shape: 'ROLE',
    examples: [
  ...
  { shape: 'EMAIL', examples: [] },
  { shape: 'USERNAME', examples: [] },
  { shape: 'PERSON_FIRST_NAME', examples: [] },
  { shape: 'PERSON_LAST_NAME', examples: [] },
  { shape: 'UUID', examples: [] },
  {
    shape: 'VEHICLE_IDENTIFICATION_NUMBER',
    examples: [
      '6KYHESJB049262788',
      'Q5KYRAXF733690086',
      'MS7WB21B223849986',
  ...
  },
  {
    ...
    examples: [
      ...
      'blog/2024/02/title-of-the-blog-post',
      'events/upcoming/webinar-title',
      'faq',
      'help/how-to-use-our-platform',
      'login',
      'signup',
      'profile/user-name',
      'dashboard',
      ...
      'resources/e-books/ebook-title',
      'webinar/register/title-of-webinar',
      'news/2024/title-of-news-article',
      'careers/job-title',
      'testimonials',
      ...
      'promotions/sale-name',
      'events/year/event-name',
      'community/topics/topic-name',
      'forums/thread/thread-title',
      'reviews/product-name',
      'compare/product-name-vs-product-name',
      'how-to/guide-title',
  ...
  { shape: 'BANK_ACCOUNT_NUMBER_LAST4', examples: [] },
  { shape: 'BANK_ROUTING_FULL', examples: [] },
  { shape: 'BANK_ROUTING_LAST4', examples: [] },
  { shape: 'CHECKSUM', examples: [] },
  { shape: 'CREDIT_DEBIT_CVV', examples: [] },
  { shape: 'CREDIT_DEBIT_EXPIRY', examples: [] },
  { shape: 'CREDIT_DEBIT_NUMBER', examples: [] },
  { shape: 'DRIVER_ID', examples: [] },
  { shape: 'EMPLOYER_IDENTIFICATION_NUMBER', examples: [] },
  { shape: 'HASH', examples: [] },
  { shape: 'IMAGE_RAW', examples: [] },
  { shape: 'LOCATION_GPS_COORDINATE', examples: [] },
  { shape: 'LOCATION_LATITUDE', examples: [] },
  { shape: 'LOCATION_LONGITUDE', examples: [] },
  { shape: 'LOGS', examples: [] },
  { shape: 'META_DATA', examples: [] },
  { shape: 'NATIONAL_IDENTIFICATION_NUMBER', examples: [] },
  { shape: 'PIN', examples: [] },
  { shape: 'SEARCH_VECTOR', examples: [] },
  { shape: 'SSN_FULL', examples: [] },
  { shape: 'SSN_LAST4', examples: [] },
  { shape: 'STATUS', examples: [] },
  { shape: 'TAX_CODE', examples: [] },
]
