...
import {
  ...
  DataModelModel,
  DataModelSequence,
} from '~/generateOrm/index.js'
import { Relationship } from '~/db/introspect/introspectDatabase.js'

export type IntrospectedSqlite = AsyncFunctionSuccessType<
  typeof introspectSqliteDatabase
>
...
export function introspectedSqliteToDataModel(
