...
export const introspection: IntrospectedStructure = {
  ...
  indexes: [
    ...
    },
    {
      schema: 'public',
      table: 'ShapePredictionStore',
      index: 'ShapePredictionStore_input_engine_idx',
      definition:
        'CREATE INDEX "ShapePredictionStore_input_engine_idx" ON public."ShapePredictionStore" USING btree (input, engine)',
      type: 'btree',
